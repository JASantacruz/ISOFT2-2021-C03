...
public interface Estado {
	 ...
	 */
	 String SERVIDO = "Los comensales estan comiendo los platos que han pedido.";
	/**
	 ...
	 */
	 String PAGANDO = "Los comensales ya tienen la cuenta en la mesa.";
	/**
	 * Cuando los comensales se han retirado de la mesa, y los camareros la estan preparando para que vuelva a estar libre
	 */
	 String EN_PREPARACION = "Los comensales se han retirado, y se esta preparando la mesa.";
